...
function Tc(e, n, t, r, l, o, u, i, s) {
  (Et = !1), (Rr = null), zc.apply(Lc, arguments);
}
...
Ga = function (e, n, t) {
  ...
  else (ae = !1), j && (n.flags & 1048576) !== 0 && qs(n, Br, n.index);
...
hs = Nu;
ys = Ln;
var kd = { usingClientEntryPoint: !1, Events: [Jt, Un, ll, ms, vs, Nu] },
  ht = {
      ...
      children: [
        Ql('div', {
          children: [
            ...
            wn('a', {
              href: 'https://github.com/darciovilela',
              target: '_blank',
              children: wn('img', {
                src: 'https://avatars.githubusercontent.com/u/9962604?v=4',
                className: 'logo darcio',
                alt: 'darcio',
              }),
            }),
          ],
        }),
        wn('h1', { children: 'Darcio Vilela' }),
        wn('div', {
          className: 'card',
          children: Ql('button', {
            onClick: () => n((t) => t + 1),
...
Kl.createRoot(document.getElementById('root')).render(
  wn(gc.StrictMode, { children: wn(zd, {}) })
);
